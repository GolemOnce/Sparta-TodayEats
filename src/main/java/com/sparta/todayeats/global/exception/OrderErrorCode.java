...
public enum OrderErrorCode implements ErrorCode {
    ...
    ORDER_ACCESS_DENIED(HttpStatus.BAD_REQUEST, "ORDER-007", "본인 주문만 결제할 수 있습니다."),
    ORDER_ALREADY_CANCELLED(HttpStatus.BAD_REQUEST, "ORDER-008", "취소된 주문은 결제할 수 없습니다."),
    ORDER_CONFLICT(HttpStatus.CONFLICT, "ORDER-009", "다른 요청이 처리 중입니다. 잠시 후 다시 시도해주세요.");
